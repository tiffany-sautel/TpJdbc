...
public class TestJDBC {
	// Chaine de connexion
	static final String CONNECT_URL = "jdbc:mysql://mysql-tiff2983.alwaysdata.net:3306/tiff2983_jdbc1";
	static final String LOGIN = "tiff2983_user1";
	static final String PASSWORD = "bball";
	// La requete de test
